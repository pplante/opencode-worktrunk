...
### Changed
- Note bun install for local checkout by @pplante
- Clarify wt -C directory for merge by @pplante

### Fixed
- Guard merge against self-merge from target by @pplante

## [0.3.1] - 2026-09-13

### Changed
- V0.3.1 by @pplante
- Switch to git-cliff for release notes by @pplante
...
[0.3.2]: https://github.com/pplante/opencode-worktrunk/compare/v0.3.1...v0.3.2
